...
polygonSeries.mapPolygons.template.fill = chart.colors.getIndex(64).lighten(0.5);
...
marker.fill = chart.colors.getIndex(29).brighten(-0.4);
...
lineTemplate.stroke = chart.colors.getIndex(29).brighten(-0.2);
