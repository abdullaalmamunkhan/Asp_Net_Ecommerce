...
{
    public class ProductAttributeItemMapRepo : GenericRepo<DBProductAttributeItemMap>, IProductAttributeItemMapRepo
    {
        private readonly ApplicationDbContext _context;
        protected readonly IStoredProcedure _storedProcedure;
        public ProductAttributeItemMapRepo(ApplicationDbContext context, IStoredProcedure storedProcedure) : base(context)
        {
            _context = context;
